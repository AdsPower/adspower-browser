    ...
    'browser.create.roundtrip.proxy-and-fingerprint-optional-subset': {
        ...
        roundtrip: {
            optionalCoverageByInputPath: {
                ...
                user_proxy_config_proxy_type: 'user_proxy_config',
                user_proxy_config_proxy_host: 'user_proxy_config',
                user_proxy_config_proxy_port: 'user_proxy_config',
                user_proxy_config_proxy_user: 'user_proxy_config',
                user_proxy_config_proxy_password: 'user_proxy_config',
                user_proxy_config_proxy_url: 'user_proxy_config',
